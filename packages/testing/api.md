...
// @public
export function mockSelector<TState, TArgs extends any[], TReturn, TMock extends (...args: TArgs) => TReturn>(selector: SimpluxSelectorMarker<TState, TArgs, TReturn>, mockFn: TMock): [TMock, () => void];
